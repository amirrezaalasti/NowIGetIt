...
source_dir = Path("artifacts/5d9a09d03200/scenes")
dest_dir = Path("heating_demands/internal_heat_gain")
...
# Add Master FullInternalHeatGainVideo class
merged_code += """
...
print(f"Merged scenes for Internal Heat Gain successfully. Scene classes: {[c[0] for c in class_info]}")

# Create build_full_video.py for Internal Heat Gain
...
build_script += """    ]
    ...
    final_output = base_dir / "Full_Internal_Heat_Gain_Video_HQ.mp4"
...
print("build_full_video.py created for Internal Heat Gain.")
