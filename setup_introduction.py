...
source_dir = Path("artifacts/e818ac72f6c9/scenes")
dest_dir = Path("heating_demands/introduction")
...
# Add Master FullIntroductionVideo class
merged_code += """
...
print(f"Merged scenes for Introduction successfully. Scene classes: {[c[0] for c in class_info]}")

# Create build_full_video.py for Introduction
...
print("build_full_video.py created for Introduction.")
