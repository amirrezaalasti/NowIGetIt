...
source_dir = Path("artifacts/a2f8fe3c0085/scenes")
dest_dir = Path("heating_demands/solar_heat_gain")
dest_dir.mkdir(parents=True, exist_ok=True)

# Sort scene directories numerically by prefix index if present or natural sort
...
# Add Master FullSolarHeatGainVideo class
merged_code += """
...
print(f"Merged scenes for Solar Heat Gain successfully. Scene classes: {[c[0] for c in class_info]}")

# Create build_full_video.py for Solar Heat Gain
...
build_script += """    ]
    ...
    final_output = base_dir / "Full_Solar_Heat_Gain_Video_HQ.mp4"
...
print("build_full_video.py created for Solar Heat Gain.")
