  ...
  return createMcpHandler(
    ...
    },
    {
      ...
      instructions:
        ...
        "Manim house template (enforced by video_codegen_spec): import manim_fonts/manim_visuals; apply_scene_style first; scene_title + play_scene_title; formula_panel for equations; type-scale constants; Text/body_text only — never MathTex; no caption_bar/hold_for. Documents: upload_document, poll get_document, ask_document. Show figure images from those tools. " +
