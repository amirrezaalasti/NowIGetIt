...
class Scene1(Scene):
    def construct(self):
        ...
        hot_label = Text("HOT", font_size=22, color=WHITE).move_to(left_block.get_center())
        cold_label = Text("COLD", font_size=22, color=WHITE).move_to(right_block.get_center())
        ...
        eq_label = Text("WARM (EQUILIBRIUM)", font_size=20, color=WHITE).move_to(np.array([0, -0.2, 0]))
        ...
        new_subtitle = Text("Microscopic Lattice & Conduction Barrier", font_size=18, color=GREY_A)
        ...
        ins_text = Text("Insulation Layer", font_size=14, color="#F2C94C")
        ...
        blocked_text = Text("Air Gaps Stop Thermal Conduction", font_size=16, color="#FF9F43")
...
class Scene2(Scene):
    def construct(self):
        ...
        # 2. Title
        title = Text("Measuring Resistance: The R-Value", font_size=32, color="#F0F0F0")
        ...
        rect_label = Text("Insulation", font_size=20, color=WHITE)
        ...
        formula_sub = Text(
            "R: Thermal Resistance | d: Thickness | λ: Conductivity",
            font_size=16,
            color="#B0BEC5"
        )
        ...
        double_text = Text("2x Thickness → 2x Resistance", font_size=18, color="#81C784")
...
class Scene3(Scene):
    def construct(self):
        ...
        # --- Title ---
        main_title = Text("Thermal Transmittance & Temperature Gradient", font_size=28, color=WHITE)
        main_title.to_edge(UP, buff=0.4)
        self.play(Write(main_title), run_time=0.8)
        self.wait(0.3)
        
        # --- Beat 1: R to U = 1 / R ---
        r_text = Text("Thermal Resistance:  R", font_size=30, color=pastel_yellow)
        r_text.move_to(UP * 1.2)
        self.play(FadeIn(r_text, shift=UP * 0.2), run_time=0.8)
        self.wait(0.5)
        
        u_eq = Text("Thermal Transmittance:  U = 1 / R", font_size=30, color=WHITE)
        u_eq.move_to(UP * 1.2)
        
        u_subtext = Text("U-value measures heat flow rate per unit area and temperature difference", font_size=16, color=pastel_blue)
        ...
        area_title = Text("Heat Loss Scales with Surface Area (A)", font_size=26, color=WHITE)
        ...
        unit_label = Text("Unit Area = 1 m²", font_size=18, color=pastel_red)
        ...
        grid_label = Text("Total Surface Area (A) = 25 m²", font_size=18, color=pastel_green)
        ...
        graph_title = Text("Temperature Profile Across Wall", font_size=26, color=WHITE)
        ...
        x_label_in = Text("Indoor", font_size=15, color=WHITE).move_to(axes.c2p(0.5, -25) + DOWN * 0.3)
        x_label_wall = Text("Wall", font_size=15, color=WHITE).move_to(axes.c2p(1.5, -25) + DOWN * 0.3)
        x_label_out = Text("Outdoor", font_size=15, color=WHITE).move_to(axes.c2p(2.5, -25) + DOWN * 0.3)
        ...
        steep_note = Text("Steeper Gradient = Higher Heat Flow Rate", font_size=18, color=pastel_yellow)
...
class Scene4(Scene):
    def construct(self):
        ...
        title = Text("The Building Thermal Envelope", font_size=32, color=pastel_cyan)
        title.to_edge(UP, buff=0.3)

        eq_text = Text("Total Heat Loss = Σ ( U_i × A_i × ΔT_i )", font_size=26, color=pastel_white)
        ...
        roof_label = Text("Roof", font_size=16, color=pastel_orange).next_to(roof_arrow, UP, buff=0.1)
        ...
        win_label = Text("Windows", font_size=16, color=pastel_orange).next_to(win_arrow, LEFT, buff=0.1)
        ...
        wall_l_label = Text("Walls", font_size=16, color=pastel_orange).next_to(wall_l_arrow, LEFT, buff=0.1)
        ...
        door_label = Text("Doors", font_size=16, color=pastel_orange).next_to(door_arrow, RIGHT, buff=0.1)
        ...
        floor_label = Text("Foundation", font_size=16, color=pastel_orange).next_to(floor_arrow, DOWN, buff=0.1)
        ...
        note = Text("Summing Envelope Loss: Roof + Windows + Walls + Doors + Foundation", font_size=18, color=pastel_teal)
