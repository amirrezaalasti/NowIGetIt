...
def main():
    ...
    scenes = [
        ("Scene1Transition", base_dir / "scene_1_audio.mp3"),
        ("Scene2IrradianceAndArea", base_dir / "scene_2_audio.mp3"),
        ("Scene3GValue", base_dir / "scene_3_audio.mp3"),
        ("SeasonalSunAngles", base_dir / "scene_4_audio.mp3"),
        ("Scene5ShadingFactor", base_dir / "scene_5_audio.mp3"),
        ("ThermalMassScene", base_dir / "scene_6_audio.mp3"),
        ("Scene7MasterEquation", base_dir / "scene_7_audio.mp3"),
    ]
    
    muxed_clips = []
    
    for idx, (scene_name, audio_path) in enumerate(scenes, start=1):
        print(f"--- Rendering {scene_name} (Scene {idx}/7) ---")
